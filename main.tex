...
all different, because, in general, there is no reason to choose one
over the other.
%
If no more than two of them are different, it succeeds and provides an
...
\acks{ This work was supported in part by SIGPLAN PAC funding.  We
