...
\end{Verbatim}
Terms \texttt{(\textcolor{blue}{::}) : C [Int, List Int] (List Int)}
...
\end{minted}	
%
More precisely the script traverses and processes their nodes
...
type to such a function, i.e.  \texttt{⟪\_⟫ : ES → HList ?},
...
%
Preventing undefined operations and maintaining such
invariants is the bread and butter of dependently-typed
...
\paragraph{Example}
Invalid scripts, such as \texttt{[Ins (\textcolor{blue}{::}) , Ins
  \textcolor{magenta}{0}]}, are now ill-typed.
%
In particular, edit \texttt{Ins (\textcolor{blue}{::})} cannot be
prepended to script \texttt{[Ins \textcolor{magenta}{0}] : ES [] [Int]},
because the target index has not the right shape, i.e. \texttt{[Int] ≠
  [Int, List Int] ++ ys}.


  The following script
encodes the differences between two lists of integers, namely
\texttt{[0]} and \texttt{[1,2]}, as witnessed by its richer type:
\begin{Verbatim}[commandchars=\\\{\}]
