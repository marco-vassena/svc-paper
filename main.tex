...
%
Operator \texttt{⊔₃} merges \emph{aligned} edit scripts, by applying
operator \texttt{⊔} pairwise, i.e.\ \texttt{e₁ ⊔₃ e₂ = zipWith (⊔) e₁
  e₂}.
...
\texttt{ws} should have prefix \texttt{as}, i.e.\ \texttt{ws ≡ as ++
