...
\end{minted}
	...
	\\ \hline
	\texttt{Del α} & \texttt{Upd α β} & \textcolor{Red}{\texttt{Cnf (Del α) (Upd α β) (⟨ α ⟩ ≠ ⊥) (⟨ α ⟩ ≠ ⟨ β ⟩)  (⊥ ≠ ⟨ β ⟩) (DelUpd α β) }}
	\\ \hline
	\texttt{Upd α β} & \texttt{Del α} & \textcolor{Red}{\texttt{Cnf (Upd α β) (Del α) (⟨ α ⟩ ≠ ⟨ β ⟩) (⟨ α ⟩ ≠ ⊥) (⟨ β ⟩ ≠ ⟨ α ⟩) (UpdDel α β)}}
	\\ \hline
	\texttt{Ins α} & \texttt{Ins α} & \textcolor{Green}{\texttt{Idem (Ins α)}} 
	\\	\hline
	\texttt{Ins α} & \texttt{Ins β} & \textcolor{Red}{\texttt{Cnf (Ins α) (Ins β) (⊥ ≠ ⟨ α ⟩) (⊥ ≠ ⟨ β ⟩) (⟨ α ⟩ ≠ ⟨ β ⟩) (InsIns α β)}}
	\\	\hline
	\texttt{Upd α β} & \texttt{Upd α β} & \textcolor{Green}{\texttt{Idem (Upd α β)}}
	\\	\hline
	\texttt{Upd α β} & \texttt{Upd α γ} & \textcolor{Red}{\texttt{Cnf (Upd α β) (Upd α γ) (⟨ α ⟩ ≠ ⟨ β ⟩) ( ⟨ α ⟩ ≠ ⟨ γ ⟩) (⟨ β ⟩ ≠ ⟨ γ ⟩) (UpdUpd α β γ)}}
	\\ \hline
	\end{tabular}
