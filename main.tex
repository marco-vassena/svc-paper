...
\end{minted}	
	...
	a \emph{target} object of type \texttt{HList ys}. 
        ...
        and \texttt{[\textcolor{blue}{0},1,2,3]}, the first rows of the tables 
...
\end{minted}
	...
	In our implementation the \texttt{diff} algorithm employed is a 
        ...
        which will be discussed in section \href{sec:related-work}.
...
have been verified with the Agda proof assistant using the model presented in this paper.
