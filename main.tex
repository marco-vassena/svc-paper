...
their subtrees to their fields.
\begin{minted}{agda}
...
\end{minted}
	...
	In section \ref{sec:haskell} we show how it is possible to implement these 
...
\end{minted}
	...
	alignment since this property can be enforced directly with their types.
...
\end{minted}
	The alignment proof is passed  as an instance argument, i.e. a
        ...
        in Fig \ref{fig:merge3}.  \todo{This was called Diff3 in the
          thesis, but I think Merge3 is more appropriate because it is
          a reification of the function merge3}
